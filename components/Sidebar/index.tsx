...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ...
      className={`z-9999 dark:bg-boxdark absolute left-0 top-0 flex h-screen flex-col overflow-y-hidden bg-[#020832] text-white duration-300 ease-linear lg:static lg:translate-x-0 ${
      ...
      <div className="py-5.5 lg:py-6.5 flex items-center justify-between gap-2 px-6">
        <Link href="/">
          <Image
            ...
            width={176}
            height={32}
            src={"/images/logo/whitespace.jpg"}
            alt="Logo"
            priority
          />
        </Link>
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/vendor" || pathname.includes("vendor")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/tender" || pathname.includes("tender")
                }
              >
                {(handleClick, open) => {
                  return (
